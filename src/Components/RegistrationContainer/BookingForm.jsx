...
//           </p>
//         </small>
//         <Link className="btn-primary" to="/confirmation">
//           Book Table
//         </Link>
//       </div>
//     </form>
...
export default function ReservationForm(props) {
  ...
  {/* <div>
    <label htmlFor="time">Select Time</label> <br></br>
    <select id="time" required onChange={(e) => props.setSelectedTime(e.target.value)}>
      {finalTime}
    </select>
  </div> */}
...
<div>
         <label htmlFor="time">Select Time</label> <br></br>
         {/* <input type='time' id="time" required onChange={(e)=> props.setTime(e.target.value)} ></input> */}
         <select id="time" >
           {time}
         </select>
       </div>
  ...
  <div>
    ...
    <button className="btn-primary" onClick={props.handleReservation}>
      Book Table
    </button>
  </div>
</form>
